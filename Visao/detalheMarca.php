...
if(isset($_GET['id'])){
    $marca = ControllerMarca::buscarMarcaPorId($_GET['id']);
...
<div class="col-10">
    <a href="marca.php" class="btn btn-primary btn-sm">Voltar</a>
    <br>
    <?php


    if($marca->getId() <=0){
        echo "<h3>Nenhuma marca foi encontrada</h3>";
    }else{//mostrar os dados

        echo "<h3>Detalhes</h3><hr>";
        echo "<h6><label class='text-center'><b>Código da Marca<b>:&nbsp;</label>";
        echo utf8_decode($marca->getId());
        echo "<hr>";

        echo "<h6>Descrição</h6>";
        echo utf8_decode($marca->getDescricao());
