...
<div class="col-md-12 d-md-block">
    ...
    <form action="#" method="post"> <!-- # chama o proprio arquivo-->
        <div class="form-group text-left">
            ...
            <a href="marca.php" class="btn btn-danger btn-sm" name="cancelar">Cancelar</a>
        </div>
        <input type="hidden" name="id" value="<?php echo $marca->getId();?>">
        <div class="form-group row">
            <div class="col-12">
                <label>Descrição</label>
                <input type="text" name="descricao" placeholder="Descrição do Produto" class="form-control" value="<?php echo $marca->getDescricao();?>">
            </div>
        </div>
