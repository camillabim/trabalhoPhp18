...
<div class="col-10">
    <a href="categoria.php" class="btn btn-primary btn-sm">Voltar</a>
    <br>
    <?php


    if($categoria->getId() <=0){
        echo "<h3>Nenhuma categoria foi encontrada</h3>";
    }else{//mostrar os dados

        echo "<h3>Detalhes</h3><hr>";
        echo "<h6><label class='text-center'><b>Código da Categoria<b>:&nbsp;</label>";
        echo utf8_decode($categoria->getId());
        echo "<hr>";

        echo "<h6>Descrição</h6>";
        echo utf8_decode($categoria->getDescricao());
