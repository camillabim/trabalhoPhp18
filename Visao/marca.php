...
if(isset($_GET['id'])){
    ControllerMarca::excluir($_GET['id']); // chamo o método para excluir antes do método de atualizar a página
    header('Location: marca.php'); //reescreve o cabeçalho da página para nao ficar mostrand sempre o código de exclusão
}


$item = ControllerMarca::buscarTodos();
...
<div class="col-12">
    ...
    <table class="table table-hover">
        ...
        <a type="button" href="inserirMarca.php" class="btn btn-primary btn-sm">Cadastrar Novo</a>
        ...
        <tr>
            ...
            <th width="50%">Descrição da Marca</th>
        ...
        <?php
        foreach ($item as $marca) { //LISTA EH UM VETOR DE MARCA

            echo "<tr>";
            echo "<td width=\"10%\">".$marca->getId()."</td>" ;
            echo "<td width=\"50%\">".$marca->getDescricao()."</td>";
            echo "<td width=\"15%\">";

            echo "<a href='marca.php?id=".$marca->getId()."' class='btn btn-danger' title='Excluir' alt='Excluir '><img src='../svg/si-glyph-delete.svg' width='15' height='15'></a>";
            echo "<a href='detalheMarca.php?id=".$marca->getId()."' class='btn btn-success' title='Detalhes' alt='Detalhes '><img src='../svg/si-glyph-badge-name.svg' width='15' height='15'></a>";
            echo "<a href='inserirMarca.php?id=".$marca->getId()."' class='btn btn-info ' title='Editar' alt='Editar'><img src='../svg/si-glyph-edit.svg' width='15' height='15'></a>";
