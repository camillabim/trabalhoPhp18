...
if (isset($_POST['entrar'])){
    ...
    $usuarioSistema= ControllerUsuarioSistema::login($usuarioSistema);
    //echo var_dump($usuarioSistema);
    if($usuarioSistema->getId() > 0){
        //$_SESSION['usuario'] = $usuarioSistema; // dentro da sessão do usuario tem o objeto
        $_SESSION['usuario'] = serialize($usuarioSistema);
