...
$produtos = ControllerProdutos::buscarProdutoPorCategoria();
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									...
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											<h6>Acessórios</h6>
											<li><a href="catnotebook.php">Notebook</a></li>
					...
					<div class="w3ls_mobiles_grid_left_grid">
						...
						<div class="w3ls_mobiles_grid_left_grid_sub">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										...
										<li><a href="products2.html">Tv</a></li>
										<li><a href="listaProdutos.php">Wearables</a></li>
							...
							<ul class="panel_bottom">
								<li><a href="listaProdutos.php">Summer Store</a></li>
								<li><a href="listaProdutos.php">Featured Brands</a></li>
								<li><a href="listaProdutos.php">Today's Deals</a></li>
								<li><a href="listaProdutos.php">Latest Watches</a></li>
							</ul>
						</div>
					</div>
					<div class="w3ls_mobiles_grid_left_grid">
                    ...
                    <div class="w3ls_mobiles_grid_right_grid3">
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                ...
                                <div class="simpleCart_shelfItem">
                                    ...
                                    echo "<a href='detalhesproduto.php?idproduto=" . $produto->getId() . "' title='Detalhes' alt='Detalhes'>" . $produto->getValorUnitario() . "</a>";
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Digital Watch</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">i3 Laptop</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Digital Watch2</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Asus Tablet</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Security Camera</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Pen Camera</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Golden Tablet</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="detalhesproduto.php">Multicolor Laptop </a></h5>
								<div class="simpleCart_shelfItem">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<h5><a href="detalhesproduto.php">Kid's Toy</a></h5>
							<div class="simpleCart_shelfItem"> 
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<h5><a href="detalhesproduto.php">Vacuum Cleaner</a></h5>
							<div class="simpleCart_shelfItem">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<h5><a href="detalhesproduto.php">Microwave Oven</a></h5>
							<div class="simpleCart_shelfItem">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<h5><a href="detalhesproduto.php">Music MP3 Player</a></h5>
							<div class="simpleCart_shelfItem">
								<p><span>$60</span> <i class="item_price">$58</i></p>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
