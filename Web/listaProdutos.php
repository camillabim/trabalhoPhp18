...
<body> 
	...
	<div class="header" id="home1">
		<div class="container">
			...
			<div class="w3l_logo">
				<h1><a href="index.php">VendaS/A<span></span></a></h1>
			</div>
			<div class="search">
	...
	<div class="banner banner1">
		<div class="container">
			<h2>Grandes Ofertas <span>Em toda a loja</span> Desconto <i>35% Disconto</i></h2>
		</div>
	</div> 
	<!-- breadcrumbs -->
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				<li><a href="index.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Página Inicial</a> <i>/</i></li>
				<li>Produtos</li>
			</ul>
		</div>
	</div>
                    ...
                    ?>
                        ...
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
                            <div class="agile_ecommerce_tab_left mobiles_grid">
                                ...
                                echo "<h5><a href='detalhesproduto.php?idproduto=" . $produto->getId() . "' title='Detalhes' alt='Detalhes'>" . $produto->getDescricao() . "</a></h5>";

                                ?>
                                <div class="simpleCart_shelfItem">
                                    <?php
                                    echo "Valor R$"."<a href='detalhesproduto.php?idproduto=" . $produto->getId() . "' title='Detalhes' alt='Detalhes'>" . $produto->getValorUnitario() . "</a>";
