		...
		<div class="container">
			...
			<div class="col-md-8 single-right">
                ...
                <div class="quantidadeEstoque">
                    <h5><i>Quantidade em Estoque: <?php echo $produto->getEstoque();?></i></h5>
                </div>

                <br>
                <div class="marca">
                    <h5><i>Marca: <?php echo $produto->getMarca()->getDescricao();?></i></h5>
                </div>
                <br>
                <div class="categoria">
                    <h5><i>Categoria: <?php echo $produto->getCategoria()->getDescricao();?></i></h5>
                </div>

                <br>
				<div class="simpleCart_shelfItem">
                    <i class="item_price">Valor: R$<?php echo $produto->getValorUnitario();?>,00</i></p>
		...
		<div class="container">
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					<ul>
						<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Informação do Produto</span></li>
						<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Comentários</span></li>
					</ul>		
					...
					<div class="tab-2 resp-tab-content additional_info_grid" aria-labelledby="tab_item-1">
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<a href="detalhesproduto.php">Laura</a>
									<h5>Oct 06, 2016.</h5>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<a href="detalhesproduto.php">Michael</a>
									<h5>Oct 04, 2016.</h5>
									<p>Quis autem vel eum iure reprehenderit qui in ea voluptate 
										velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat 
										quo voluptas nulla pariatur.</p>
